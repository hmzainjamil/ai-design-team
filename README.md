...
> **A multi-agent design squad that ships brand systems while you sleep** — Python orchestrator that runs Strategist + Researcher + Designer + Critic agents in parallel and outputs a Figma-ready brand system with logos, palettes, and copy.

<p align="center">
  <img src="https://img.shields.io/badge/ai--design--team-live-success?style=for-the-badge&labelColor=0d1117" alt="ai-design-team"/>
</p>

<p align="center">
  <a href="https://github.com/hmzainjamil/ai-design-team/stargazers"><img alt="Stars" src="https://img.shields.io/github/stars/hmzainjamil/ai-design-team?style=for-the-badge&labelColor=0d1117&color=ffd700&logo=github&logoColor=white"/></a>
  <a href="https://github.com/hmzainjamil/ai-design-team/network/members"><img alt="Forks" src="https://img.shields.io/github/forks/hmzainjamil/ai-design-team?style=for-the-badge&labelColor=0d1117&color=2ecc71&logo=github&logoColor=white"/></a>
  <a href="https://github.com/hmzainjamil/ai-design-team/issues"><img alt="Issues" src="https://img.shields.io/github/issues/hmzainjamil/ai-design-team?style=for-the-badge&labelColor=0d1117&color=ff6b6b&logo=github&logoColor=white"/></a>
  <a href="https://github.com/hmzainjamil/ai-design-team/pulls"><img alt="PRs" src="https://img.shields.io/github/issues-pr/hmzainjamil/ai-design-team?style=for-the-badge&labelColor=0d1117&color=9b59b6&logo=github&logoColor=white"/></a>
  <a href="https://github.com/hmzainjamil/ai-design-team/graphs/contributors"><img alt="Contributors" src="https://img.shields.io/github/contributors/hmzainjamil/ai-design-team?style=for-the-badge&labelColor=0d1117&color=3498db&logo=github&logoColor=white"/></a>
  <a href="https://github.com/hmzainjamil/ai-design-team/commits/main"><img alt="Commits" src="https://img.shields.io/github/commit-activity/m/hmzainjamil/ai-design-team?style=for-the-badge&labelColor=0d1117&color=e67e22&logo=git&logoColor=white"/></a>
  <a href="https://github.com/hmzainjamil/ai-design-team/commits/main"><img alt="Last commit" src="https://img.shields.io/github/last-commit/hmzainjamil/ai-design-team?style=for-the-badge&labelColor=0d1117&color=8e44ad&logo=git&logoColor=white"/></a>
</p>
...
Hiring a brand designer is $8k and 3 weeks. This is $40 of Claude tokens and 18 minutes. The quality isn't equivalent — it's 80%, which is the right tradeoff for MVPs and internal tools.

Four agents, each with a specific persona and toolset. They debate, critique, and converge. The orchestrator logs the full reasoning trail so you can see *why* the palette is what it is.

Used to ship the brand systems for 14 internal projects this year. None of them have made me embarrassed yet.
...
| | |
|---|---|
| **What** | Python orchestrator that runs Strategist + Researcher + Designer + Critic agents in parallel and outputs a Figma-ready brand system with logos, palettes, and copy. |
...
- **4-agent squad** — non-negotiable, you'll feel its absence.
- **Figma-ready output** — non-negotiable, you'll feel its absence.
- **Reasoning trail** — non-negotiable, you'll feel its absence.
- **Logo + palette + copy** — non-negotiable, you'll feel its absence.
- **18-min runtime** — non-negotiable, you'll feel its absence.
- **$40/brand** — non-negotiable, you'll feel its absence.
...
```bash
git clone https://github.com/hmzainjamil/ai-design-team.git && cd ai-design-team
```
...
|---|---|---|---|---|
| **ai-design-team** | ✅ Opinionated | ✅ Production-tested | ✅ Single-author velocity | ✅ Hackable in an evening |
...
```bibtex
@misc{ ai_design_team_2026,
  author = {Zain Jamil, Hamza},
  title  = { ai-design-team: A multi-agent design squad that ships brand systems while you sleep },
  year   = {2026},
  url    = {https://github.com/hmzainjamil/ai-design-team}
}
```
...
```bash
0 7 * * * cd /opt/ai-design-team && ./run.sh --task daily-digest --notify slack
```
...
<a href="https://star-history.com/#hmzainjamil/ai-design-team&Date">
  <img src="https://api.star-history.com/svg?repos=hmzainjamil/ai-design-team&type=Date" alt="Star History" />
</a>
