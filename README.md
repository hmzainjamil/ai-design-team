...
Four agents, each with a specific persona and toolset. They debate, critique, converge. The orchestrator logs the full reasoning trail so you can see *why* the palette is what it is.
...
| | |
|---|---|
| **What** | Python orchestrator running Strategist + Researcher + Designer + Critic in parallel — outputs a Figma-ready brand system. |
